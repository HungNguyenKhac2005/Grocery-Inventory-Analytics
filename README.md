...
![System Architecture](pictures/architecture.jpg)
...
## 🔍 6. SQL Analytics *(see details in the [reports.pdf](reports/reports.pdf) file in the [reports](reports) folder)*
...
**Business Question:** Filter out the Top 3 suppliers with the most *Active* items, and the Top 3 suppliers with the most *Discontinued* items.
...
## 💡 7. Business Recommendations *(see details in the [reports.pdf](reports/reports.pdf) file in the [reports](reports) folder)*
